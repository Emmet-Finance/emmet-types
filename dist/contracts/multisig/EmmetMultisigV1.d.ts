...
export interface EmmetMultisigV1Interface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "SIGNER_ROLE" | "claimReward" | "claimRole" | "emmetToken" | "encodeParams" | "generateHash" | "getRoleAdmin" | "grantRole" | "hasRole" | "hashes" | "minStake" | "nonce" | "previouslyProposedTransactions" | "propose" | "renounceRole" | "revokeRole" | "rewardAmounts" | "rewards" | "roleRequests" | "sign" | "stake" | "stakes" | "supportsInterface" | "threshold" | "totalSigners" | "transactions" | "unstake"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "generateHash", values: [BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "previouslyProposedTransactions", values: [BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "previouslyProposedTransactions", data: BytesLike): Result;
...
export interface EmmetMultisigV1 extends BaseContract {
    connect(runner?: ContractRunner | null): EmmetMultisigV1;
    waitForDeployment(): Promise<this>;
    interface: EmmetMultisigV1Interface;
    ...
    previouslyProposedTransactions: TypedContractMethod<[
    ...
    getFunction(nameOrSignature: "previouslyProposedTransactions"): TypedContractMethod<[
        chainId: BigNumberish,
        txHash: string
    ], [
        boolean
