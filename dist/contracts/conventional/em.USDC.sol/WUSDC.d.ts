...
export interface WUSDCInterface extends Interface {
...
export interface WUSDC extends BaseContract {
    connect(runner?: ContractRunner | null): WUSDC;
    waitForDeployment(): Promise<this>;
    interface: WUSDCInterface;
