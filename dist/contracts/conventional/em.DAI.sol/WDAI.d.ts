...
export interface WDAIInterface extends Interface {
...
export interface WDAI extends BaseContract {
    connect(runner?: ContractRunner | null): WDAI;
    waitForDeployment(): Promise<this>;
    interface: WDAIInterface;
