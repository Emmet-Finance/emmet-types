...
export declare namespace Mock {
  export type CallDataStruct = {
    offset1: BigNumberish;
    offset2: BigNumberish;
    admin: AddressLike;
  };

  export type CallDataStructOutput = [
    offset1: bigint,
    offset2: bigint,
    admin: string
  ] & { offset1: bigint; offset2: bigint; admin: string };
}
...
export interface MockInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, Mock.CallDataStruct]
  ): string;
...
export interface Mock extends BaseContract {
  ...
  updateAdmin: TypedContractMethod<
    [txHash: BytesLike, newAdmin: Mock.CallDataStruct],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[txHash: BytesLike], [void], "payable">;
  getFunction(
