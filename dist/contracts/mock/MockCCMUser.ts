...
export interface MockCCMUserInterface extends Interface {
  getFunction(
    nameOrSignature: "ccm" | "estimateFee" | "feedback" | "sendMessage"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, boolean, string, BytesLike[], string[]]
  ): string;
  encodeFunctionData(
...
export interface MockCCMUser extends BaseContract {
  ...
  filters: {
    "Feedback(bytes32,bool,string,bytes[],address[])": TypedContractEvent<
      FeedbackEvent.InputTuple,
      FeedbackEvent.OutputTuple,
      FeedbackEvent.OutputObject
    >;
