...
export interface CCMStorageInterface extends Interface {
...
export interface CCMStorage extends BaseContract {
    connect(runner?: ContractRunner | null): CCMStorage;
    waitForDeployment(): Promise<this>;
    interface: CCMStorageInterface;
