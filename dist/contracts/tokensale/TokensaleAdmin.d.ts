...
export interface TokensaleAdminInterface extends Interface {
    getFunction(nameOrSignature: "CFO_ROLE" | "DEFAULT_ADMIN_ROLE" | "INTERVAL" | "LOCK_PERIOD" | "MANAGER_ROLE" | "RELEASE" | "UPGRADE_INTERFACE_VERSION" | "_admin_init" | "addPriceRange" | "cash" | "cfo" | "coinWithdraw" | "computeRefKey" | "decimals" | "discountGroups" | "discounts" | "getRefOwner" | "getRoleAdmin" | "grantRole" | "hasRole" | "locked" | "manager" | "pause" | "paused" | "proxiableUUID" | "references" | "renounceRole" | "revokeRole" | "rewards1" | "rewards2" | "sold" | "supportsInterface" | "unpause" | "updateCFO" | "updateDecimals" | "updateManager" | "updatePriceRange" | "updateRewards" | "upgradeToAndCall" | "users" | "vesting" | "vestingStart" | "withdrawCash" | "withdrawToken"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "updateDecimals", values: [BigNumberish, BigNumberish]): string;
...
export interface TokensaleAdmin extends BaseContract {
    connect(runner?: ContractRunner | null): TokensaleAdmin;
    waitForDeployment(): Promise<this>;
    interface: TokensaleAdminInterface;
    ...
    getFunction(nameOrSignature: "updateDecimals"): TypedContractMethod<[
        soldDecimals: BigNumberish,
        cashDecimals: BigNumberish
    ], [
        void
