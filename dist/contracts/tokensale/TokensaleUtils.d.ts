...
export interface TokensaleUtilsInterface extends Interface {
...
export interface TokensaleUtils extends BaseContract {
    connect(runner?: ContractRunner | null): TokensaleUtils;
    waitForDeployment(): Promise<this>;
    interface: TokensaleUtilsInterface;
