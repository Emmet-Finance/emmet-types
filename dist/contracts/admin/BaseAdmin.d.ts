...
export interface BaseAdminInterface extends Interface {
    getFunction(nameOrSignature: "CFO_ROLE" | "DEFAULT_ADMIN_ROLE" | "MANAGER_ROLE" | "UPGRADE_INTERFACE_VERSION" | "_admin_init" | "cfo" | "coinWithdraw" | "getRoleAdmin" | "grantRole" | "hasRole" | "manager" | "pause" | "paused" | "proxiableUUID" | "renounceRole" | "revokeRole" | "supportsInterface" | "unpause" | "updateCFO" | "updateManager" | "upgradeToAndCall"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Initialized" | "Paused" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "RoleUdated" | "Unpaused" | "Upgraded" | "Withdraw"): EventFragment;
...
export interface BaseAdmin extends BaseContract {
    connect(runner?: ContractRunner | null): BaseAdmin;
    waitForDeployment(): Promise<this>;
    interface: BaseAdminInterface;
