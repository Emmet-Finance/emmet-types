...
export interface UpdatableBridgeInterface extends Interface {
    getFunction(nameOrSignature: "BRIDGE_ROLE" | "DEFAULT_ADMIN_ROLE" | "bridge" | "getRoleAdmin" | "grantRole" | "hasRole" | "renounceRole" | "revokeRole" | "supportsInterface" | "updateBridge"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BridgeUpdated" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked"): EventFragment;
...
export interface UpdatableBridge extends BaseContract {
    connect(runner?: ContractRunner | null): UpdatableBridge;
    waitForDeployment(): Promise<this>;
    interface: UpdatableBridgeInterface;
