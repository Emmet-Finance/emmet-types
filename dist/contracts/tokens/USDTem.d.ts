...
export interface USDTemInterface extends Interface {
...
export interface USDTem extends BaseContract {
    connect(runner?: ContractRunner | null): USDTem;
    waitForDeployment(): Promise<this>;
    interface: USDTemInterface;
