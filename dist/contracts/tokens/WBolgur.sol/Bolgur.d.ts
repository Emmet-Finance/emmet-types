...
export interface BolgurInterface extends Interface {
...
export interface Bolgur extends BaseContract {
    connect(runner?: ContractRunner | null): Bolgur;
    waitForDeployment(): Promise<this>;
    interface: BolgurInterface;
