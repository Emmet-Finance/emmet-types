...
export interface MATICInterface extends Interface {
...
export interface MATIC extends BaseContract {
    connect(runner?: ContractRunner | null): MATIC;
    waitForDeployment(): Promise<this>;
    interface: MATICInterface;
