...
export interface ETONInterface extends Interface {
...
export interface ETON extends BaseContract {
    connect(runner?: ContractRunner | null): ETON;
    waitForDeployment(): Promise<this>;
    interface: ETONInterface;
