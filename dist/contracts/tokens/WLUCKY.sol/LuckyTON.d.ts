...
export interface LuckyTONInterface extends Interface {
...
export interface LuckyTON extends BaseContract {
    connect(runner?: ContractRunner | null): LuckyTON;
    waitForDeployment(): Promise<this>;
    interface: LuckyTONInterface;
