...
export interface EmmetBridgeInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [BridgeTypes.SendParamsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "sendMessage",
    values: [BigNumberish, BigNumberish, string, BytesLike, BytesLike, boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawStuck",
    values: [BytesLike]
  ): string;
