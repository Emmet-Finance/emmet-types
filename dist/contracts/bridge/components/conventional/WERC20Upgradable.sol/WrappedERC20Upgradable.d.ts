...
export interface WrappedERC20Upgradable extends BaseContract {
    connect(runner?: ContractRunner | null): WrappedERC20Upgradable;
    waitForDeployment(): Promise<this>;
    interface: WrappedERC20UpgradableInterface;
