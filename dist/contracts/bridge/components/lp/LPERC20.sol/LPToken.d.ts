...
export interface LPTokenInterface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "_admin" | "_bridge" | "allowance" | "approve" | "balanceOf" | "decimals" | "eip712Domain" | "name" | "nonces" | "permit" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "updateAdmin" | "updateBridge"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AdminUpdate" | "Approval" | "BridgeUpdate" | "EIP712DomainChanged" | "Transfer"): EventFragment;
    encodeFunctionData(functionFragment: "DOMAIN_SEPARATOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "_admin", values?: undefined): string;
    encodeFunctionData(functionFragment: "_bridge", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "_bridge", data: BytesLike): Result;
...
export declare namespace BridgeUpdateEvent {
...
export interface LPToken extends BaseContract {
    ...
    _bridge: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "_admin"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "_bridge"): TypedContractMethod<[], [string], "view">;
    ...
    getEvent(key: "BridgeUpdate"): TypedContractEvent<BridgeUpdateEvent.InputTuple, BridgeUpdateEvent.OutputTuple, BridgeUpdateEvent.OutputObject>;
    getEvent(key: "EIP712DomainChanged"): TypedContractEvent<EIP712DomainChangedEvent.InputTuple, EIP712DomainChangedEvent.OutputTuple, EIP712DomainChangedEvent.OutputObject>;
    getEvent(key: "Transfer"): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    filters: {
        "AdminUpdate(address,address)": TypedContractEvent<AdminUpdateEvent.InputTuple, AdminUpdateEvent.OutputTuple, AdminUpdateEvent.OutputObject>;
        ...
        "BridgeUpdate(address,address)": TypedContractEvent<BridgeUpdateEvent.InputTuple, BridgeUpdateEvent.OutputTuple, BridgeUpdateEvent.OutputObject>;
        BridgeUpdate: TypedContractEvent<BridgeUpdateEvent.InputTuple, BridgeUpdateEvent.OutputTuple, BridgeUpdateEvent.OutputObject>;
