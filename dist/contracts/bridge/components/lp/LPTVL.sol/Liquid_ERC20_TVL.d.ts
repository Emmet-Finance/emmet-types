...
export interface Liquid_ERC20_TVLInterface extends Interface {
    getFunction(nameOrSignature: "SECONDS_IN_A_YEAR" | "allowance" | "approve" | "apy" | "balanceOf" | "decimals" | "name" | "poolBalance" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "tvl" | "underlying"): FunctionFragment;
...
export interface Liquid_ERC20_TVL extends BaseContract {
    connect(runner?: ContractRunner | null): Liquid_ERC20_TVL;
    waitForDeployment(): Promise<this>;
    interface: Liquid_ERC20_TVLInterface;
