...
export namespace LPUpdateEvent {
  export type InputTuple = [symbol: string, operation: string];
  export type OutputTuple = [symbol: string, operation: string];
  export interface OutputObject {
    symbol: string;
    operation: string;
  }
...
export interface LPModule extends BaseContract {
  ...
  updateLP: TypedContractMethod<
    [pool: AddressLike, symbol: string],
    [void],
    "nonpayable"
  >;
  ...
  getEvent(
    ...
    LPUpdateEvent.InputTuple,
    LPUpdateEvent.OutputTuple,
    LPUpdateEvent.OutputObject
  >;
  getEvent(
    key: "Paused"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "LPUpdate(string,string)": TypedContractEvent<
      LPUpdateEvent.InputTuple,
      LPUpdateEvent.OutputTuple,
      LPUpdateEvent.OutputObject
    >;
    LPUpdate: TypedContractEvent<
      LPUpdateEvent.InputTuple,
      LPUpdateEvent.OutputTuple,
      LPUpdateEvent.OutputObject
    >;
