...
export namespace UpdateChainEvent {
  export type InputTuple = [chainId: BigNumberish, cctpId: BigNumberish];
  export type OutputTuple = [chainId: bigint, cctpId: bigint];
  export interface OutputObject {
    chainId: bigint;
    cctpId: bigint;
  }
...
export namespace UpdateTokenEvent {
  export type InputTuple = [symbol: string, token: AddressLike];
  export type OutputTuple = [symbol: string, token: string];
  export interface OutputObject {
    symbol: string;
    token: string;
  }
...
export namespace UpdateTokenFeeEvent {
  export type InputTuple = [symbol: string, fee: BigNumberish];
  export type OutputTuple = [symbol: string, fee: bigint];
  export interface OutputObject {
    symbol: string;
    fee: bigint;
  }
...
export interface CCTPModule extends BaseContract {
  ...
  updateChain: TypedContractMethod<
    [chainId: BigNumberish, cctpId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  updateTokenFee: TypedContractMethod<
    [fee: BigNumberish, symbol: string],
    [void],
    "nonpayable"
  >;
  ...
  getEvent(
    ...
    UpdateChainEvent.InputTuple,
    UpdateChainEvent.OutputTuple,
    UpdateChainEvent.OutputObject
  >;
  getEvent(
    key: "UpdateToken"
  ): TypedContractEvent<
    UpdateTokenEvent.InputTuple,
    UpdateTokenEvent.OutputTuple,
    UpdateTokenEvent.OutputObject
  >;
  getEvent(
    key: "UpdateTokenFee"
  ): TypedContractEvent<
    UpdateTokenFeeEvent.InputTuple,
    UpdateTokenFeeEvent.OutputTuple,
    UpdateTokenFeeEvent.OutputObject
  >;
  getEvent(
    key: "Withdraw"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "UpdateChain(uint128,uint32)": TypedContractEvent<
      UpdateChainEvent.InputTuple,
      UpdateChainEvent.OutputTuple,
      UpdateChainEvent.OutputObject
    >;
    UpdateChain: TypedContractEvent<
      UpdateChainEvent.InputTuple,
      UpdateChainEvent.OutputTuple,
      UpdateChainEvent.OutputObject
    >;

    "UpdateToken(string,address)": TypedContractEvent<
      UpdateTokenEvent.InputTuple,
      UpdateTokenEvent.OutputTuple,
      UpdateTokenEvent.OutputObject
    >;
    UpdateToken: TypedContractEvent<
      UpdateTokenEvent.InputTuple,
      UpdateTokenEvent.OutputTuple,
      UpdateTokenEvent.OutputObject
    >;

    "UpdateTokenFee(string,uint256)": TypedContractEvent<
      UpdateTokenFeeEvent.InputTuple,
      UpdateTokenFeeEvent.OutputTuple,
      UpdateTokenFeeEvent.OutputObject
    >;
    UpdateTokenFee: TypedContractEvent<
      UpdateTokenFeeEvent.InputTuple,
      UpdateTokenFeeEvent.OutputTuple,
      UpdateTokenFeeEvent.OutputObject
    >;
