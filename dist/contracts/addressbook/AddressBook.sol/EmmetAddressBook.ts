...
export namespace AddressUpdateEvent {
...
export interface EmmetAddressBook extends BaseContract {
  ...
  getEvent(
    ...
    AddressUpdateEvent.InputTuple,
    AddressUpdateEvent.OutputTuple,
    AddressUpdateEvent.OutputObject
  >;
  getEvent(
    key: "CCMUpdated"
  ): TypedContractEvent<
  ...
  filters: {
    "AddressUpdate(address,address,string)": TypedContractEvent<
      AddressUpdateEvent.InputTuple,
      AddressUpdateEvent.OutputTuple,
      AddressUpdateEvent.OutputObject
    >;
    AddressUpdate: TypedContractEvent<
      AddressUpdateEvent.InputTuple,
      AddressUpdateEvent.OutputTuple,
      AddressUpdateEvent.OutputObject
    >;
