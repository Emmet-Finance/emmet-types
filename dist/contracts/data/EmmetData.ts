...
export interface EmmetDataInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "estimateForeignCost",
    values: [BigNumberish, string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getIncomingTransaction",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getIncommingTransactions",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getIndexByHash",
    values: [BytesLike, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "getNativeCoinName",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getOutgoingTransaction",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getOutgoingTransactions",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface EmmetData extends BaseContract {
  ...
  convert: TypedContractMethod<
    [amountA: BigNumberish, symbolA: string, symbolB: string],
    [bigint],
    "view"
  >;
  ...
  getIndexByHash: TypedContractMethod<
    [txHash: BytesLike, isOut: boolean],
    [bigint],
    "view"
  >;
  ...
  getStrategy: TypedContractMethod<
    [toChainId: BigNumberish, fromToken: string, toToken: string],
  ...
  >;
  getFunction(
    nameOrSignature: "estimateForeignCost"
  ): TypedContractMethod<
    [chainId: BigNumberish, fromToken: string, toToken: string],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "getIncomingTransaction"
  ): TypedContractMethod<[index: BigNumberish], [bigint], "view">;
  getFunction(
    nameOrSignature: "getIncommingTransactions"
  ): TypedContractMethod<
    [batch: BigNumberish, skip: BigNumberish],
    [bigint[]],
    "view"
  >;
  getFunction(
    nameOrSignature: "getIndexByHash"
  ): TypedContractMethod<[txHash: BytesLike, isOut: boolean], [bigint], "view">;
  getFunction(
    nameOrSignature: "getNativeCoinName"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "getOutgoingTransaction"
  ): TypedContractMethod<
    [index: BigNumberish],
    [BridgeTypes.SendParamsStructOutput],
    "view"
  >;
  getFunction(
    nameOrSignature: "getOutgoingTransactions"
  ): TypedContractMethod<
    [batch: BigNumberish, skip: BigNumberish],
    [BridgeTypes.SendParamsStructOutput[]],
    "view"
