...
export interface EmmetDataInterface extends Interface {
    getFunction(nameOrSignature: "DataAdmin" | "convert" | "estimateForeignCost" | "getChain" | "getIncomingTransaction" | "getIncommingTransactions" | "getIndexByHash" | "getNativeCoinName" | "getOutgoingTransaction" | "getOutgoingTransactions" | "getStrategy" | "getToken" | "supportsInterface"): FunctionFragment;
    encodeFunctionData(functionFragment: "DataAdmin", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "DataAdmin", data: BytesLike): Result;
...
export interface EmmetData extends BaseContract {
    ...
    DataAdmin: TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "DataAdmin"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "getIndexByHash"): TypedContractMethod<[txHash: BytesLike, isOut: boolean], [bigint], "view">;
