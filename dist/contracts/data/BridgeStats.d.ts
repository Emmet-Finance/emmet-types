...
export interface BridgeStatsInterface extends Interface {
...
export interface BridgeStats extends BaseContract {
    connect(runner?: ContractRunner | null): BridgeStats;
    waitForDeployment(): Promise<this>;
    interface: BridgeStatsInterface;
