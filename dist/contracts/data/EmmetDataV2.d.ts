...
export interface EmmetDataV2Interface extends Interface {
    getFunction(nameOrSignature: "ADMIN_ROLE" | "estimateForeignFees" | "getChain" | "getForeignFee" | "getForeignStrategies" | "getIncomingStrategies" | "getLocalStrategies" | "getNativeCoinName" | "getStrategies" | "getToken" | "isChainSupported" | "isTokenSupported" | "nativeTokenName" | "roles" | "setChain" | "setChains" | "setStrategies" | "setToken" | "supportsInterface" | "updateAdmin"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "nativeTokenName", values?: undefined): string;
    encodeFunctionData(functionFragment: "roles", values: [AddressLike]): string;
    encodeFunctionData(functionFragment: "setChain", values: [BigNumberish, IDataTypes.ChainStruct]): string;
    encodeFunctionData(functionFragment: "setChains", values: [BigNumberish[], IDataTypes.ChainStruct[]]): string;
    ...
    encodeFunctionData(functionFragment: "setToken", values: [string, AddressLike, BigNumberish, BigNumberish, AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "nativeTokenName", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "roles", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setChain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setChains", data: BytesLike): Result;
...
export interface EmmetDataV2 extends BaseContract {
    connect(runner?: ContractRunner | null): EmmetDataV2;
    waitForDeployment(): Promise<this>;
    interface: EmmetDataV2Interface;
    ...
    nativeTokenName: TypedContractMethod<[], [string], "view">;
    roles: TypedContractMethod<[bearer: AddressLike], [string], "view">;
    setChain: TypedContractMethod<[
        chainId: BigNumberish,
        chain: IDataTypes.ChainStruct
    ], [
        void
    ], "nonpayable">;
    setChains: TypedContractMethod<[
        chainIds: BigNumberish[],
        chains: IDataTypes.ChainStruct[]
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "nativeTokenName"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "roles"): TypedContractMethod<[bearer: AddressLike], [string], "view">;
    getFunction(nameOrSignature: "setChain"): TypedContractMethod<[
        chainId: BigNumberish,
        chain: IDataTypes.ChainStruct
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "setChains"): TypedContractMethod<[
        chainIds: BigNumberish[],
        chains: IDataTypes.ChainStruct[]
    ], [
        void
