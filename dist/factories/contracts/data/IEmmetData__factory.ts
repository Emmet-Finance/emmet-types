...
import type {
  IEmmetData,
  IEmmetDataInterface,
} from "../../../contracts/data/IEmmetData";
...
export class IEmmetData__factory {
  static readonly abi = _abi;
  static createInterface(): IEmmetDataInterface {
    return new Interface(_abi) as IEmmetDataInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IEmmetData {
    return new Contract(address, _abi, runner) as unknown as IEmmetData;
  }
}
