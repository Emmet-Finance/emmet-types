...
import type {
  IEmmetDataAdmin,
  IEmmetDataAdminInterface,
} from "../../../contracts/data/IEmmetDataAdmin";
...
export class IEmmetDataAdmin__factory {
  static readonly abi = _abi;
  static createInterface(): IEmmetDataAdminInterface {
    return new Interface(_abi) as IEmmetDataAdminInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IEmmetDataAdmin {
    return new Contract(address, _abi, runner) as unknown as IEmmetDataAdmin;
  }
}
