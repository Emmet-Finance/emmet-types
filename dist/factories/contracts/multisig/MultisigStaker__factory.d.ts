...
import type { MultisigStaker, MultisigStakerInterface } from "../../../contracts/multisig/MultisigStaker";
export declare class MultisigStaker__factory {
    ...
    static createInterface(): MultisigStakerInterface;
    static connect(address: string, runner?: ContractRunner | null): MultisigStaker;
}
