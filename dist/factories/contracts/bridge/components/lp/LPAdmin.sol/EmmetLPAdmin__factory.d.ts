...
import type { EmmetLPAdmin, EmmetLPAdminInterface } from "../../../../../../contracts/bridge/components/lp/LPAdmin.sol/EmmetLPAdmin";
export declare class EmmetLPAdmin__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): EmmetLPAdmin;
}
