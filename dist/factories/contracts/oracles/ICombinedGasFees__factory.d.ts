...
import type { ICombinedGasFees, ICombinedGasFeesInterface } from "../../../contracts/oracles/ICombinedGasFees";
export declare class ICombinedGasFees__factory {
    ...
    static createInterface(): ICombinedGasFeesInterface;
    static connect(address: string, runner?: ContractRunner | null): ICombinedGasFees;
}
